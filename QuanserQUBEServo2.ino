...
void loop() {
  ...
  if (currentMicros - previousMicros >= sampleTime) {
    ...
    /*Turn on motor*/
    //motorVoltage = 0;
    /*switch (millis()%(seqTime*3)){
    case 0 ... seqTime:{
    motorVoltage = 0;
    break;
    }
    case seqTime+1 ... seqTime*2:{
    motorVoltage = 1;
    break;
    }
    case seqTime*2+1 ... seqTime*3:{
    motorVoltage = -1;
    break;
    }
    }*/
